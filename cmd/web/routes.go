...
func routes(app *config.AppConfig) http.Handler {
	...
	mux.Get("/S-class", handlers.Repo.Sclass)
	mux.Get("/E-class", handlers.Repo.Eclass)
	...
	mux.Route("/admin", func(mux chi.Router) {
		...
		mux.Get("/reservations-all", handlers.Repo.AdminAllResevation)
		mux.Get("/reservations-calendar", handlers.Repo.AdminCalendar)
		mux.Post("/reservations-calendar", handlers.Repo.PostAdminCalendar)
